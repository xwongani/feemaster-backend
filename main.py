...
from app.routes import auth, students, payments, dashboard, reports, integrations, settings as settings_routes, financial
...
async def startup_event():
    ...
    await receipt_service.initialize()
...
async def shutdown_event():
    ...
    await receipt_service.cleanup()
    await analytics_service.cleanup()
    
    logger.info("Fee Master Backend shut down successfully")
